...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SqlStatus'
        db.create_table(u'formplayer_sqlstatus', (
            ('username', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
            ('app_version', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'formplayer', ['SqlStatus'])


    def backwards(self, orm):
        # Deleting model 'SqlStatus'
        db.delete_table(u'formplayer_sqlstatus')
    ...
    models = {
        ...
        u'formplayer.sqlstatus': {
            'Meta': {'object_name': 'SqlStatus'},
            'app_version': ('django.db.models.fields.IntegerField', [], {}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'})
        },
        'formplayer.xform': {
