...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'formplayer_session', (
            ('sess_id', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
            ('sess_json', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'formplayer', ['Session'])


    def backwards(self, orm):
        # Deleting model 'Session'
        db.delete_table(u'formplayer_session')
