...
DATABASES = {
    'default': {
        ...
        'NAME': 'xforms.db',             # Or path to database file if using sqlite3.
...
import os
STATIC_DOC_ROOT = os.path.join(os.path.dirname(__file__), "xforms", "static")
